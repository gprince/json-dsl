...
public interface JsonValue<T> {
     ...
     * 
     */
    final class JsonArray extends AbstractValue<List<JsonValue<?>>> implements JsonStructure<JsonValue<?>> {
     ...
     */
    static final JsonNull<JsonArray> NULL_ARRAY = new JsonNull<JsonArray>(JsonArray.class);

    /**
     * The immutable null BigDecimal
     */
    static final JsonNull<BigDecimal> NULL_BIG_DECIMAL = new JsonNull<BigDecimal>(BigDecimal.class);

    /**
     * The immutable null Boolean
     */
    static final JsonNull<Boolean> NULL_BOOLEAN = new JsonNull<Boolean>(Boolean.class);

    /**
     * The immutable null Double
     */
    static final JsonNull<Double> NULL_DOUBLE = new JsonNull<Double>(Double.class);

    /**
     * The immutable null Integer
     */
    static final JsonNull<Integer> NULL_INTEGER = new JsonNull<Integer>(Integer.class);
    /**
     ...
     */
    static final JsonNull<String> NULL_STRING = new JsonNull<String>(String.class);

    /**
     * The immutable null Object
     */
    static final JsonNull<JsonObject> NULL_OBJECT = new JsonNull<JsonObject>(JsonObject.class);
    ...
    class JsonNumber<T extends Number> extends AbstractValue<T> {
         ...
         *             if the type parameter or the value parameter is null
         */
        public JsonNumber(T value, Class<T> type) throws IllegalArgumentException {
            super(value, type);
        }
    ...
    /**
     * This class represents an immutable Member of Object
     * 
     * @author gprince
     */
    final class JsonMember<T extends JsonValue<?>> implements Serializable {
         ...
         */
        public JsonMember(String name, T value) {
            this.name = name;
            this.value = value;
        }
     ...
     * 
     */
    final class JsonObject extends AbstractValue<ArrayList<JsonMember<?>>> implements JsonStructure<JsonMember<?>> {
         ...
         */
        public JsonObject() {
            super(new ArrayList<JsonMember<?>>());
        }
        ...
        public void add(String name, JsonValue<?> value) {
            super.value.add(new JsonMember<JsonValue<?>>(name, value));
        }
        ...
        public String toString() {
            ...
            for (JsonMember<?> member : super.value) {
