...
public final class Builders {
	...
	public static class ObjectBuildable implements JsonObjectBuildable {
		...
		@Override
		public JsonArrayBuilder<JsonObjectBuildable> startArray(String name) {
			// TODO Auto-generated method stub
			return null;
		}

		@Override
		public JsonObjectBuilder<JsonObjectBuildable> startObject(String name) {
			return new ObjectBuilder<>(this);
		}

		@Override
		public JsonObjectBuildable add(String name, BigDecimal value)
		...
		@Override
		public JsonObjectBuildable add(String name, Boolean value)
				throws JsonBuildException {
			append(this.object, name, value);
			return this;
		}
		...
		@Override
		public JsonObjectBuildable add(String name, Double value)
				throws JsonBuildException {
			append(this.object, name, value);
			return this;
		}
		...
		@Override
		public JsonObjectBuildable add(String name, Integer value)
				throws JsonBuildException {
			append(this.object, name, value);
			return this;
		}
		...
		@Override
		public JsonObjectBuildable add(String name, Long value)
				throws JsonBuildException {
			append(this.object, name, value);
			return this;
		}
		...
		@Override
		public JsonObjectBuildable add(String name, String value)
				throws JsonBuildException {
			append(this.object, name, value);
			return this;
		}
		...
		@Override
		public JsonObjectBuildable add(String name, JsonObject value)
				throws JsonBuildException {
			append(this.object, name, value);
			return this;
		}
		...
		@Override
		public JsonObjectBuildable add(String name, JsonArray value)
				throws JsonBuildException {
			append(this.object, name, value);
			return this;
		}
		...
		@Override
		public JsonObjectBuildable merge(JsonObject object)
				throws JsonBuildException {
	 ...
	 * @param <T>
	 */
	public static class ObjectBuilder<T extends JsonBuilder> implements
			JsonObjectBuilder<T> {
		...
		@Override
		public JsonObjectBuilder<T> add(String name, Integer value)
				throws JsonBuildException {
			append(object, name, value);
			return this;
		}
		...
		@Override
		public JsonObjectBuilder<T> add(String name, JsonObject value)
				throws JsonBuildException {
			append(object, name, value);
			return this;
		}
		...
		@Override
		public JsonObjectBuilder<T> add(String name, JsonArray value)
				throws JsonBuildException {
			append(object, name, value);
			return this;
		}
		...
		@Override
		public JsonObjectBuilder<T> merge(JsonObject object)
				throws JsonBuildException {
			this.object.merge(object);
			return this;
		}
		 ...
		 * @throws JsonBuildException
		 */
		private ObjectBuilder(JsonBuilder parentBuibler, String name)
				throws JsonBuildException {
	 ...
	 * @param <T>
	 */
	public static class ArrayBuilder<T extends JsonBuilder> implements
			JsonArrayBuilder<T> {
		...
		@Override
		public JsonArrayBuilder<T> add(JsonObject object) {
			// TODO Auto-generated method stub
			return null;
		}

		@Override
		public JsonArrayBuilder<T> add(JsonArray array) {
			// TODO Auto-generated method stub
			return null;
		}
		 ...
		 * @throws JsonBuildException
		 */
		private ArrayBuilder(JsonBuilder parentBuibler, String name)
				throws JsonBuildException {
			// Name can not be null
			if (StringUtils.isEmpty(name)) {
				throw new JsonBuildException(BUILD_EXCEPTION_NULL_NAME,
	 ...
	 * @throws JsonBuildException
	 */
	private static void append(JsonObject object, String name, Object value)
			throws JsonBuildException {
		// Name can not be null
		if (StringUtils.isEmpty(name)) {
			throw new JsonBuildException(BUILD_EXCEPTION_NULL_NAME,
	...
	public static void main(String[] args) throws JsonBuildException {
		JsonObject object = jsonObject().add("String", "String")
				.startArray("Array").startArray().startArray().endArray()
				.endArray().endArray().startObject("Object").endObject()
				.build();
