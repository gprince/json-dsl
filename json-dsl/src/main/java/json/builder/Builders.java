...
public final class Builders {
    ...
    protected interface IObjectBuilder<B extends IObjectBuilder<?>> {
        ...
        B add(java.lang.String name, java.math.BigDecimal value) throws JsonBuildException;

        B add(java.lang.String name, java.lang.Boolean value) throws JsonBuildException;

        B add(java.lang.String name, java.lang.Double value) throws JsonBuildException;

        B add(java.lang.String name, java.lang.Integer value) throws JsonBuildException;

        B add(java.lang.String name, java.lang.Long value) throws JsonBuildException;

        B add(java.lang.String name, java.lang.String value) throws JsonBuildException;
    ...
    public static class RootObjectBuilder extends RootBuilder<Object> implements IObjectBuilder<RootObjectBuilder> {

        @Override
        public RootObjectBuilder add(java.lang.String name, java.math.BigDecimal value) throws JsonBuildException {
        ...
        @Override
        public RootObjectBuilder add(java.lang.String name, java.lang.Boolean value) throws JsonBuildException {
            // Name can not be null
            if (StringUtils.isEmpty(name)) {
                throw new JsonBuildException(BUILD_EXCEPTION_NULL_NAME, new IllegalArgumentException());
            }
        ...
        @Override
        public RootObjectBuilder add(java.lang.String name, java.lang.Double value) throws JsonBuildException {
            // Name can not be null
            if (StringUtils.isEmpty(name)) {
                throw new JsonBuildException(BUILD_EXCEPTION_NULL_NAME, new IllegalArgumentException());
            }
        ...
        @Override
        public RootObjectBuilder add(java.lang.String name, java.lang.Integer value) throws JsonBuildException {
            // Name can not be null
            if (StringUtils.isEmpty(name)) {
                throw new JsonBuildException(BUILD_EXCEPTION_NULL_NAME, new IllegalArgumentException());
            }
        ...
        @Override
        public RootObjectBuilder add(java.lang.String name, java.lang.Long value) throws JsonBuildException {
            // Name can not be null
            if (StringUtils.isEmpty(name)) {
                throw new JsonBuildException(BUILD_EXCEPTION_NULL_NAME, new IllegalArgumentException());
            }
        ...
        @Override
        public RootObjectBuilder add(java.lang.String name, java.lang.String value) throws JsonBuildException {
            // Name can not be null
            if (StringUtils.isEmpty(name)) {
                throw new JsonBuildException(BUILD_EXCEPTION_NULL_NAME, new IllegalArgumentException());
            }
    ...
    public static class RootArrayBuilder extends RootBuilder<Array> implements IArrayBuilder<RootArrayBuilder> {
    ...
    public static class ObjectBuilder<T extends Builder<?>> extends ChildBuilder<T, Object> implements
        ...
        @Override
        public ObjectBuilder<T> add(java.lang.String name, java.math.BigDecimal value) {
            if (value != null) {
                getValue().add(name, new BigDecimal(value));
            } else {
                getValue().add(name, NULL_BIG_DECIMAL);
        ...
        @Override
        public ObjectBuilder<T> add(java.lang.String name, java.lang.Boolean value) {
            if (value != null) {
                if (value)
                    getValue().add(name, TRUE);
                else
        ...
        @Override
        public ObjectBuilder<T> add(java.lang.String name, java.lang.Double value) {
            if (value != null) {
                getValue().add(name, new Double(value));
            } else {
                getValue().add(name, NULL_DOUBLE);
        ...
        @Override
        public ObjectBuilder<T> add(java.lang.String name, java.lang.Integer value) {
            if (value != null) {
                getValue().add(name, new Integer(value));
            } else {
                getValue().add(name, NULL_INTEGER);
        ...
        @Override
        public ObjectBuilder<T> add(java.lang.String name, java.lang.String value) {
            if (value != null) {
                getValue().add(name, new String(value));
            } else {
                getValue().add(name, NULL_STRING);
    ...
    public static class ArrayBuilder<T extends Builder<?>> extends ChildBuilder<T, Array> implements
